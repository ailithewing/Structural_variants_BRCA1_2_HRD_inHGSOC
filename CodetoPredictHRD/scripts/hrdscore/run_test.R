...
if (!is.null(args[['hrdtools']])) {
    ...
    suppressMessages(library(hrdtools,lib.loc="/exports/igmm/eddie/HGS-OvarianCancerA-SGP-WGS/signatures/HRDetect/hrdetect-pipeline/dependencies/miniconda3/envs/dependencies/lib/R/library"))
}
