...
#
# qsub -t 1-n filter_by_orientation_bias_AOCS.sh CONFIG IDS
#
...
METRICS_FILE=$METRICS/${PATIENT_ID}_PrimaryTumour_artifact.pre_adapter_detail_metrics

$GATK4 --java-options "-Xmx8g" FilterByOrientationBias \
  --variant $INFILE \
  --artifact-modes 'G/T' \
